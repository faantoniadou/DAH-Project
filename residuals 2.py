...
#%%
region1 =  np.array(xmass)[np.where((xmass > 9.78) & (xmass < 10.19))]
...
def background():
    ...
    side_low = xmass[np.where((xmass < edge1) & (xmass > 9.78))]
    side_high = xmass[np.where((xmass < 10.19) & (xmass > edge2))]
